...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">FED | DA</h3>
            <p className="home__description">Fresh grad from SMU School of Computer Science and Information System. Majoring in Information System (Fintech and Business Analysis)</p>
